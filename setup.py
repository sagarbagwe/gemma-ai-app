...
# This is the full code for the Streamlit application.
# The setup script will automatically create 'agent.py' with this content.
app_code = r'''
import os
...
def run_setup():
    ...
    <div style="border: 2px solid #4CAF50; border-radius: 10px; padding: 20px; background-color: #f0fff0; margin: 20px 0; font-family: sans-serif;">
        ...
        <p>To run your AI application, open your terminal and run this command:</p>
        <code style="background-color: #e8f5e9; padding: 10px 15px; border-radius: 5px; font-family: monospace; display: block; text-align: center;">streamlit run agent.py</code>
    </div>
    """
